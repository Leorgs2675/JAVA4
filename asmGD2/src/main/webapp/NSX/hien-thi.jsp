...
<div class="container">
    ...
    <div class="form-container">
        <h3 class="text-center">Add New NSX</h3>
    ...
    <!-- Table Section -->
    <h3 class="text-center mt-4">NSX List</h3>
    <table class="table table-striped table-bordered">
        ...
        <c:forEach var="nsx" items="${listnsx}">
            <tr>
                ...
                <td>${nsx.ten}</td>
                <td>
                    <a href="/nsx/nsxdelete?id=${nsx.id}" class="btn btn-danger btn-sm">Delete</a>
                    <a href="/nsx/nsxdetail?id=${nsx.id}" class="btn btn-info btn-sm">Detail</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
